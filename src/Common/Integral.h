...
public:
	...
	/************************* Some new integrals were writed by Yuanlei Zhang **************************/
	/**To calcute th line integral of (1/R^3).famula::\int_Cij(1/R^3)*/
	static double Line_R_3(const Point& ob, const Point& v0,const Point& v1);
	/**To calcute th line integral of (r/R^3).famula::\int_Cij(r/R^3)*/
	static Point Line_rR_3(const Point& ob, const Point& v0,const Point& v1);
	//calculate the line integral of  x^2/R^3, y^2/R^3, z^2/R^3, xz/R^3,yz/R^3,xy/R^3
	static double Line_x2R_3(const Point& ob, const Point& v0,const Point& v1);
	static double Line_y2R_3(const Point& ob, const Point& v0,const Point& v1);
	static double Line_z2R_3(const Point& ob, const Point& v0,const Point& v1);
	static double Line_xyR_3(const Point& ob, const Point& v0,const Point& v1);
	static double Line_xzR_3(const Point& ob, const Point& v0,const Point& v1);
	static double Line_yzR_3(const Point& ob, const Point& v0,const Point& v1);

	/****A new method to compute the integral of \iint 1/R^3 ds***/
	static double Surface_R_3(const Point& ob, const vector<Node*>& face_node, int n);
	static double Surface_R_5(const Point& observation, const vector<Node*>& face_node, int n);
	static Point Surface_rR_5(const Point& observation, const vector<Node*>& face_node, int n);

	static double Surface_x2R_5(const Point& observation, const vector<Node*>& face_node, int n);
	static double Surface_y2R_5(const Point& observation, const vector<Node*>& face_node, int n);
	static double Surface_z2R_5(const Point& observation, const vector<Node*>& face_node, int n);
	static double Surface_xyR_5(const Point& observation, const vector<Node*>& face_node, int n);
	static double Surface_xzR_5(const Point& observation, const vector<Node*>& face_node, int n);
	static double Surface_yzR_5(const Point& observation, const vector<Node*>& face_node, int n);

	//To compute the surfae integral of (xp*xq*xt/R^5)ds
	static void Surface_f3R_5(const Point& ob, const vector<Node*>& face, int n,
	...
	*/
	...
	static double Surface_R_3_zyy(const Point& ob, const vector<Node*>& face_node, int n);
